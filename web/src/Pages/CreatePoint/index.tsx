...
const CreatePoint = () => {
    ...
    const [initialMapPosition, setInitialMapPosition] = useState<[number, number]>([-20.3427483, -40.293879216])
            ...
            Voltar para home
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <fieldset>
                        ...
                        <Map center={[-22.9899755, -43.2273807]} zoom={15} onClick={handleMapClick}>
                            <TileLayer
